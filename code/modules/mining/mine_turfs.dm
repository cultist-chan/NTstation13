...
/turf/simulated/mineral/random
	...
	icon_state = "rock"
	var/mineralSpawnChanceList = list("Uranium" = 15, "Diamond" = 5, "Gold" = 15, "Silver" = 25, "Plasma" = 40, "Iron" = 50, "Gibtonite" = 2/*, "Adamantine" =5*/, "Cave" = 2)//Currently, Adamantine won't spawn as it has no uses. -Durandan
