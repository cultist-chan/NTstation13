...
/turf/simulated/mineral/random
	...
	icon_state = "rock"
	var/mineralSpawnChanceList = list("Uranium" = 20, "Diamond" = 5, "Gold" = 20, "Silver" = 30, "Plasma" = 40, "Iron" = 50, "Gibtonite" = 2/*, "Adamantine" =5*/, "Cave" = 2)//Currently, Adamantine won't spawn as it has no uses. -Durandan
